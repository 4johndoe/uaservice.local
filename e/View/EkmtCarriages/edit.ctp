...
<?php echo $this->Form->create('EkmtCarriage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ekmt Carriage'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EkmtCarriage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('EkmtCarriage.id'))); ?></li>
